...
> 이 문서는 나머지 설계 문서들이 "어떻게 만들 것인가"를 다룬다면,
...
- 회사 소재지(조지아) 개인정보보호법·세제와, 글로벌 자연 유입을 전제로 한 최소 공통기준(EU AI Act 등
  역외적용 규제)을 함께 검토 — 특정 국가만 기준으로 삼지 않음
- 비용이 가장 적게 들면서, 나중에 사업 전체를 무효화할 수 있는 리스크를 가장 먼저 제거하는 단계
- 상세 체크리스트: [07-compliance.md](07-compliance.md), [15-entity-and-tax.md](15-entity-and-tax.md)
...
- 구체적인 실행 계획(타임라인·예산·측정 지표): [13-pilot-plan.md](13-pilot-plan.md)
